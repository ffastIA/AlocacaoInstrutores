# opportunity-map-screen Specification
...
- **WHEN** o mapa exibe uma data de início, um intervalo de datas ou o título do detalhe de uma oportunidade
- **THEN** as datas aparecem no formato dd/mm/aaaa, independentemente do formato ISO retornado pela API
