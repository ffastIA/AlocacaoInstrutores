...
ORIENTACOES: dict[str, list[str]] = {
    "instrutores": [
        ...
        "turnos: manha, tarde ou noite. Ex.: manha;tarde",
        "carga_horaria_turno: horas de cada turno, na MESMA ORDEM de 'turnos'. Ex.: 4;4",
        "  Alternativa: escrever manha:4;tarde:4 em 'turnos' e deixar esta coluna vazia.",
